    ...
    public function index()
    {
        ...
        if ($user->hasRole('Admin')) {
            ...
            return view('frontend.user-profile', [
                ...
                'morning_totalPrizeAmount' => $lottery_winner['morning_totalPrizeAmount'],  // Total prize amount

                 'evening_totalPrizeAmount' => $lottery_winner['evening_totalPrizeAmount'],  // Total prize amount
            ]);
        }
    }
