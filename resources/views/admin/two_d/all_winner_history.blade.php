...
@else
    <div class="table-responsive">
        <p style="color: #f5bd02">Total morning Prize Amount: {{ $morning_totalPrizeAmount }}</p>

         <p style="color: #f5bd02" class="mt-2">Total Evening Prize Amount: {{ $evening_totalPrizeAmount }}</p>
